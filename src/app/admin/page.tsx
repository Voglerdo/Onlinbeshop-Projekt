...
const ANALYTICS_DATA = [
  { name: "Mo", acquisitions: 3, revenue: 220 },
  { name: "Di", acquisitions: 4, revenue: 320 },
  { name: "Mi", acquisitions: 4, revenue: 280 },
  { name: "Do", acquisitions: 5, revenue: 420 },
  { name: "Fr", acquisitions: 7, revenue: 500 },
  { name: "Sa", acquisitions: 8, revenue: 650 },
  { name: "So", acquisitions: 6, revenue: 450 },
];
  ...
  if (isUserLoading) {
    return (
      <div className={styles.adminLayoutPrimary}>
        ...
        <p className={styles.imperialeReferenzenWerdenGepruftText}>
          Imperiale Referenzen werden geprüft...
        </p>
      </div>
    );
  }
    ...
    return (
      <div className={styles.adminLayoutSecondary}>
        ...
        <div className={styles.adminContainerPrimary}>
          <h1 className={styles.nichtAutorisierterZugriffTitle}>
            Nicht autorisierter Zugriff
          </h1>
          <p className={styles.bodyText}>
            Diese Konsole ist dem inneren Kreis des Barons vorbehalten.
          </p>
        </div>
      ...
      <Tabs defaultValue="inventory" className={styles.tabs15}>
        ...
        <TabsContent value="inventory" className={styles.tabscontent19}>
          <div className={styles.adminLayoutQuaternary}>
            <h2 className={styles.luxuskatalogHeading}>Produktkatalog</h2>
            <Link href="/admin/new">
              <Button className={styles.actionButton2}>
                <Plus className={styles.plusIcon} /> Produkt hinzufügen
              </Button>
            </Link>
          </div>
          ...
          <div className={styles.adminPanelTertiary}>
            {isProductsLoading ? (
              <div className={styles.adminLayoutQuinary}>
                <Loader2 className={styles.adminContainerQuaternary} />
              </div>
            ) : (
              <Table>
                <TableHeader className={styles.tableheader27}>
                  <TableRow>
                    ...
                    <TableHead className={styles.tablehead28}>
                      Optionen
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {products.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={5} className={styles.tablecell29}>
                        Keine Produkte im Register gefunden.
                      </TableCell>
                    </TableRow>
                  ) : (
                    products.map((product) => (
                      <TableRow key={product.id}>
                        ...
                        <TableCell className={styles.tablecell34}>
                        ...
                        <TableCell className={styles.tablehead28}>
                          <DropdownMenu>
                            ...
                            >
                              ...
                              >
                                <Trash2 className={styles.adminIconPrimary} />{" "}
                                Löschen
                              </DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
              ...
              <Table>
                ...
                <TableBody>
                  {jobs.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={5} className={styles.tablecell29}>
                        Keine offenen Positionen registriert.
                      </TableCell>
                    </TableRow>
                  ) : (
                    jobs.map((job) => (
                      <TableRow key={job.id}>
                        <TableCell>
                          <div className={styles.adminLayoutSeptenary}>
                            <span className={styles.tablecell34}>
                              {job.title}
                            </span>
                            <span className={styles.inlineText2}>
                              <MapPin className={styles.inlineText3} />{" "}
                              {job.location}
                            </span>
                          </div>
                        </TableCell>
        ...
        <TabsContent value="analytics" className={styles.tabs15}>
          <div className={styles.grid}>
            <Card className={styles.adminCardPrimary}>
              <CardHeader className={styles.adminLayoutOctonary}>
                <CardTitle className={styles.adminIconTertiary}>
                  Wöchentlicher Umsatz
                </CardTitle>
                <TrendingUp className={styles.adminIconQuaternary} />
              </CardHeader>
              <CardContent>
                <div className={styles.adminTextPrimary}>2.840€</div>
                <p className={styles.bodyText3}>
                  <ArrowUpRight className={styles.arrowUpRightIcon} /> +12,5%
                  zur Vorwoche
                </p>
              </CardContent>
            </Card>
            <Card className={styles.adminCardPrimary}>
              ...
              <CardContent>
                ...
                <p className={styles.kuratierteMeisterwerkeText}>Produkte</p>
              </CardContent>
            </Card>
            <Card className={styles.adminCardPrimary}>
              <CardHeader className={styles.adminLayoutOctonary}>
              ...
              <CardContent>
                ...
                <p className={styles.kuratierteMeisterwerkeText}>
          ...
          <Card className={styles.adminCardSecondary}>
            <CardHeader className={styles.cardheader54}>
              <CardTitle className={styles.cardtitle55}>
                Umsatzübersicht
              </CardTitle>
            </CardHeader>
