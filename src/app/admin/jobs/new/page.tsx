  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Das Angebot wurde erfolgreich an das Karriereregister gesendet.",
      });
      router.push("/admin");
    } catch (err) {
      toast({
        title: "Fehler",
        description: "Konnte die Position nicht speichern.",
        variant: "destructive",
      });
    } finally {
      setIsSaving(false);
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.adminJobsNewContainerTertiary}>
            ...
            {formData.requirements.map((req, index) => (
              <div key={index} className={styles.adminJobsNewLayoutSecondary}>
                ...
                >
                  <X className={styles.arrowLeftIcon} />
                </Button>
              </div>
            ))}
            <Button
            ...
            >
              <Plus className={styles.hinzufugenButton} /> Hinzufügen
            </Button>
          </div>
        </div>
        ...
        >
          {isSaving ? (
            ...
            <Save className={styles.loader2Icon2} />
          )}
